welcome_message <- function() {
  shinyalert(
    paste(
      "Welcome to Raynals! <br><small>This software is free for academic use. By clicking 'I accept,' you agree to the
      ...
      <a href='https://journals.iucr.org/d/issues/2023/08/00/vo5014/index.html' target='_blank' rel='noopener noreferrer'>Raynals publication</a>.
